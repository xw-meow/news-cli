  ...
  return (
    <div>
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <div className="inline-block text-left max-w-xl">
          <TerminalBlock
            lines={[
              '$ news list',
              '  google-news  —  Google News — global headlines by category',
              '  weibo        —  微博热搜榜 — 实时热搜，支持按分类和关键词过滤',
              '  cls          —  财联社 — 专业财经资讯，支持热点和头条',
              '  ithome       —  IT之家 — 前沿科技新闻，支持20个分类',
              '  ...',
              '  ---',
              '  当前已收录 16 个新闻源',
              '',
              ...
              '  │ #  │ Title                            │ Source   │ Time             │',
              '  ├────┼──────────────────────────────────┼──────────┼──────────────────┤',
              '  │ 1  │ 阿根廷球迷今天全体计划有变      │ 微博热搜 │ 2026-06-17T09:52 │',
              '  │ 2  │ 豆包每天收入不足百万            │ 微博热搜 │ 2026-06-17T10:06 │',
              '  │ 3  │ 文化中国行看端午仪式感          │ 微博热搜 │ 2026-06-17T07:03 │',
              '  └────┴──────────────────────────────────┴──────────┴──────────────────┘',
            ]}
          />
        </div>
